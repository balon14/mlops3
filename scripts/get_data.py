...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/balon/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data")
 
key = "AIzaSyDyHxUKTb8GET-4zM2nz-gvscSQX_RdBGE"
api = Api(api_key=key)
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/balon/mlops_3/scripts_mlflow/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()
 
with open('/home/balon/mlops_3/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))
